            ...
            <form action="prosesabsen.php" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Nama</td>
                                                <td><input type="text" class="form-control" name="nama" autocomplete="off" readonly="" value="<?php echo $a;?>"></td>
                                            </tr>
                                             <tr>
                                                <td>Waktu</td>
                        ...
                        <h1>Riwayat Absen <?php echo $a?></h1>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <table class='table'>
                            <thead>
                                <tr>                         
                        ...
                        <tbody>
                        <?php
                        $sql="SELECT * FROM tbl_absensi WHERE nama_karyawan='$a'";

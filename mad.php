...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <tbody>
            <tr>
            <td rowspan="2"><p>Fokus menangani jasa pembuatan aplikasi mobile  
            sesuai dengan kebutuhan dan permintaan dari klien, atau dengan kata lain Customize Project.<br><br>
            Untuk jasa pembuatan aplikasi mobile, Isoae siap melayani berbagai macam 
            aplikasi mobile.<br><br>

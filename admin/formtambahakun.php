                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        ...
                        <!--<form action="<?php echo $_SERVER["PHP_SELF"];?>" method="get">
                            <div class="form-group">
                                <label for="col-md-6">Pilih Karyawan:</label>
                        ...
                        <?php
                            if (isset($_GET['nama_karyawan'])) {
                                $nik=$_GET["nama_karyawan"];

                                $sql="select * from tbl_karyawan where nama_karyawan='$nik'";
                                $hasil=mysqli_query($con,$sql);
                        ...
                        <form method='post' action='prosestambahaku.php'>
                                    <div class='col-md-6'>
                                        <label color='control-label'>Nama Karyawan: <?/*php echo $data[1];*/?></label>
                                        <input type='text' name='namakaryawan' placeholder='' class='form-control' value=<?php /*echo $data[1];*/?>><br>

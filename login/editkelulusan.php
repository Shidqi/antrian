...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container" style="padding: 50px">
			...
			<?php
				include "../config.php";
				$hasil1=mysqli_query("SELECT * FROM peserta_pendaftar WHERE nisn='$_GET[id]'");
				$hasil=mysqli_query("SELECT * FROM nilai_ijazah WHERE nisn='$_GET[id]'");
				$data=mysqli_fetch_row($con, $hasil);
				$data1=mysqli_fetch_row($con, $hasil1);
			?>

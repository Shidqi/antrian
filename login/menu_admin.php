								...
								<?php
									...
									while ($data=mysqli_fetch_row($query)) {
										echo "<tr>
											...
											<td style=''>".$data[1]."</td>
											<td style=''>".$data[13]."</td>
											<td width='35' align='center'><a class='btn btn-sm btn-primary' href=editpeserta.php?nisn=$data[nisn]>Edit</a></td>";?>
											<td width='35' align='center'><a class='btn btn-sm btn-danger' href="admin_user.php?tombol=delete&adm_id='<?= $data[nisn]; ?>'" title="Hapus" onclick="return confirm('Apakah anda yakin ingin keluar ?')">Hapus</a></td>
											<?php
										echo "</tr>";
										$i++;
									}
